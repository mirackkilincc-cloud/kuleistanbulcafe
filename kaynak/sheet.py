...
rows = [
 ...
 ("TATLILAR — Lupin Gıda", True, "18.09.2026 — üretici içerik listesi alındı. 11 tatlının içindekileri üreticinin etiketinden yazıldı; türetilen alerjenler üreticinin beyanıyla BİREBİR tutuyor."),
 ("  Kapsanan tatlılar", False, "Frambuazlı Cheesecake (Orman Cheesecake), Limonlu Cheesecake, Süt Reçelli Cheesecake, Çikolatalı Vişne Rüyası (Vişne Badem), Yaban Mersinli Linzer, Lotus Cup (Cookietart Lotus), Snickers Pasta, Mozaik Pasta, Tiramisu Pasta, Sufle, Cedric Hindistan Cevizi (Coconat Polka)."),
 ("  Snickers Pasta", False, "Üreticinin alerjen satırında YER FISTIĞI yazmıyor ama içindekilerde yer fıstığı var. Menüde YER FISTIĞI olarak işaretledik — üreticiye bildirilmeli, etiketleri eksik."),
 ("  Sufle", False, "SERT KABUKLU YEMİŞ üretici beyanı olarak eklendi (ortak üretim hattı); içindekilerden türemiyor, menüde kaynağı 'üretici beyanı' yazıyor."),
 ("  Mozaik Pasta", False, "SOYA kaldırıldı, SERT KABUKLU YEMİŞ eklendi (file fındık) — üretici etiketine göre düzeltildi."),
 ("  Yaban Mersinli Linzer", False, "SERT KABUKLU YEMİŞ kaldırıldı — üretici etiketinde beyan edilmiyor."),
 ("  Frambuazlı Cheesecake", False, "DİKKAT: üretici ürünü 'Orman Cheesecake' — içinde frambuaz, böğürtlen ve yaban mersini var, sadece frambuaz değil. Menüdeki ad aynı bırakıldı; adı değiştirmek isterseniz söyleyin."),
 ("  TAHMİN — Cedric Limon", False, "BEK CEDRİC LİMON bu üretici listesinde YOK. İçerik, Cedric Hindistan Cevizi ve Limonlu Cheesecake'ten yola çıkılarak TAHMİNEN yazıldı. BEK etiketini gönderin, kesinleştirilecek."),
 ("  TAHMİN — Kule Ballım", False, "MENÖNİNG CLASİC BALLI bu üretici listesinde YOK. İçerik klasik ballı kek tarifinden TAHMİNEN yazıldı. Etiketini gönderin, kesinleştirilecek."),
 ("  Cedric Fıstık / Cedric Mango", False, "Hangi tedarikçiden geldiği bildirilmedi — içerikleri eski haliyle duruyor. Lupin listesinde 55.PISTACHIO var, Cedric Fıstık o mu?"),
 ("  Coconat Polka besin tablosu", False, "Üreticinin 100 g tablosunda karbonhidrat 6,16 g yazıyor ama 360 kcal ile uyuşmuyor. RA%% sütunundan yeniden hesaplandı (52 g). Üreticiye sordurun."),
 ...
 ("", False, ""),
 ("İÇECEKLER — 18.09.2026", True, "Mutfak notlarınıza göre düzeltildi."),
 ("  Milkshake", False, "DONDURMA çıkarıldı. Çilekli/Vanilyalı/Muzlu artık '<aroma> özü tozu' yazıyor. Çikolatalı'da 'çikolata sosu', Oreo'da 'Oreo bisküvi' bırakıldı — bunlar da özü tozu ise bildirin. Kaloriler yeniden tahmin edildi (450 -> ~310 kcal)."),
 ("  Frozen", False, "ŞEKER çıkarıldı, meyveler 'püresi' oldu, su eklendi (su ile seyreltiliyor). DİKKAT: hazır meyve püreleri genelde ŞEKER ve bazen SÜLFİT içerir — kullandığınız püre markasının etiketini gönderin. Kaloriler yeniden tahmin edildi."),
 ("  Mojito", False, "Üçüne de 'taze nane' ve 'limon parçası' eklendi (içine ve üstüne az miktarda)."),
 ("  Soğuk & Gazlı İçecekler", False, "Coca Cola, Cola Zero, Sprite, Fanta, Sade Soda, Meyveli Soda: içindekiler ve alerjen bloğu artık HİÇ gösterilmiyor (kapalı ambalaj). Kalori rozeti duruyor. Cappy meyve suları ve Fuse Tea'ler gazlı olmadığı için dokunulmadı — onlar da gizlenecekse söyleyin. Ayran'ın SÜT alerjeni korundu."),
 ("  Sosis Box", False, "'8 adet ızgara sosis' -> '8 adet sosis'."),
 ("  Big Combo Mix", False, "Sigara böreğinin içindekileri yazıldı (yufka, beyaz peynir, maydanoz, soda, tuz) — SÜT artık beyaz peynirden türüyor."),
 ("", False, ""),
 ("BESİN DEĞERLERİ", True, "Tatlılar bölümündeki Lupin ürünleri üreticinin 100 g beyanı x ürün gramajıdır. DİĞER TÜM ürünlerin kcal / protein / yağ / karbonhidrat değerleri TAHMİNDİR — diyetisyen doğrulaması gerekir."),
]
