...
rows = [
 ...
 ("Köri sos", False, "HARDAL olarak işaretlendi (köri karışımları çoğunlukla hardal içerir). Etiketi kontrol edin."),
 ("Köfte (tüm köfteler)", False, "GLUTEN işaretli (galeta unu/ekmek içi). Harcında YUMURTA da varsa yumurta eklenmeli."),
 ("Sweet Chili Kule Topları", False, "GLUTEN + YUMURTA işaretli (çıtır kaplama varsayıldı). Kaplamasız ise kaldırılacak."),
 ...
 ("Barbekü sos", False, "Alerjen işaretlenmedi. Hazır BBQ sosları HARDAL / KEREVİZ / SOYA içerebilir — etiketi kontrol edin."),
 ...
 ("Demi Glace et sosu", False, "Sos kartı hazır (GLUTEN, SÜT, KEREVİZ) ama hiçbir ürüne bağlı değil. Hangi yemeklerde kullanılıyor?"),
