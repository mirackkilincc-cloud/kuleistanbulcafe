...
{ id:"kahvalti", tr:"Kahvaltı", en:"Breakfast", ar:"الفطور",
  ...
  g:[
   ...
   { tr:"Omletler", en:"Omelettes", ar:"أومليت", i:[
    ["Sade Omlet","Plain Omelette","أومليت سادة",405,"Yumurta, tereyağı, tuz","Egg, butter, salt","بيض، زبدة، ملح",["Y","M"],"omelette"],
    ["Peynirli Omlet","Cheese Omelette","أومليت بالجبنة",435,"Yumurta, beyaz peynir, tereyağı, tuz","Egg, white cheese, butter, salt","بيض، جبنة بيضاء، زبدة، ملح",["Y","M"],"omelette"],
    ["Kaşarlı Omlet","Kashar Cheese Omelette","أومليت بالقشقوان",435,"Yumurta, kaşar peyniri, tereyağı, tuz","Egg, kashar cheese, butter, salt","بيض، قشقوان، زبدة، ملح",["Y","M"],"omelette"],
    ["Karışık Omlet","Mixed Omelette","أومليت مشكّل",460,"Yumurta, kaşar peyniri, sucuk, sosis, biber, tereyağı, tuz","Egg, kashar cheese, sucuk, sausage, pepper, butter, salt","بيض، قشقوان، سجق، نقانق، فلفل، زبدة، ملح",["Y","M"],"omelette"]]},
   { tr:"Sıcak Servisler", en:"Hot Plates", ar:"أطباق ساخنة", i:[
    ["Kavurmalı Yumurta","Eggs with Roasted Meat","بيض باللحم المحمّر",475,"Yumurta, et kavurma, tereyağı, tuz","Egg, roasted meat, butter, salt","بيض، لحم محمّر، زبدة، ملح",["Y","M"],"egg"],
    ["Sucuklu Yumurta","Eggs with Sucuk","بيض بالسجق",435,"Yumurta, sucuk, tereyağı, tuz","Egg, sucuk, butter, salt","بيض، سجق، زبدة، ملح",["Y","M"],"egg"],
    ["Sahanda Yumurta","Fried Eggs","بيض مقلي",380,"Yumurta, tereyağı, tuz","Egg, butter, salt","بيض، زبدة، ملح",["Y","M"],"egg"],
    ["Sahanda Sucuk","Pan-Fried Sucuk","سجق مقلي",395,"Sucuk, tereyağı","Sucuk, butter","سجق، زبدة",["M"],"egg"],
    ["Menemen","Menemen","منمن",430,"Yumurta, domates, sivri biber, tereyağı, tuz, karabiber","Egg, tomato, green pepper, butter, salt, black pepper","بيض، طماطم، فلفل أخضر، زبدة، ملح، فلفل أسود",["Y","M"],"menemen"],
    ["Kaşarlı Menemen","Menemen with Kashar","منمن بالقشقوان",460,"Yumurta, domates, sivri biber, kaşar peyniri, tereyağı, tuz, karabiber","Egg, tomato, green pepper, kashar cheese, butter, salt, black pepper","بيض، طماطم، فلفل أخضر، قشقوان، زبدة، ملح، فلفل أسود",["Y","M"],"menemen"],
...
{ id:"aparatif", tr:"Aparatifler", en:"Starters & Sides", ar:"المقبلات",
  ...
  g:[
   { tr:"Aparatifler", en:"Starters & Sides", ar:"مقبلات", i:[
    ...
    ["Cajun Finger","Cajun Chicken Fingers","أصابع دجاج كاجون",575,"Cajun baharatlı çıtır tavuk parçaları, patates, sos (yumurta, un, süt, Cajun baharatı, tuz, karabiber, soya sosu)","Cajun-spiced crispy chicken strips, fries, sauce (egg, flour, milk, Cajun spice, salt, black pepper, soy sauce)","شرائح دجاج مقرمشة بتوابل الكاجون، بطاطس، صوص (بيض، دقيق، حليب، توابل كاجون، ملح، فلفل أسود، صلصة صويا)",["G","Y","M","S"],"chicken","cajun"],
    ...
    ["Sosis Box","Sausage Box","صندوق نقانق",400,"Izgara sosis, patates","Grilled sausages, fries","نقانق مشوية، بطاطس",["G"],"combo"],
    ["Soğan Halkası","Onion Rings","حلقات بصل",400,"Soğan, galeta unu","Onion, breadcrumbs","بصل، بقسماط",["G","Y"],"combo"],
    ["Sigara Böreği","Cheese Rolls (Sigara Böreği)","لفائف الجبنة (سيجارة بوريك)",400,"Yufka, beyaz peynir, maydanoz, tuz","Yufka pastry, white cheese, parsley, salt","عجينة يوفكا، جبنة بيضاء، بقدونس، ملح",["G","M"],"borek"]]}
  ]},
{ id:"salata", tr:"Salatalar & Makarnalar", en:"Salads & Pasta", ar:"السلطات والمعكرونة",
  ...
  g:[
   { tr:"Salatalar", en:"Salads", ar:"سلطات", i:[
    ...
    ["Tavuklu Sezar Salata","Chicken Caesar Salad","سلطة سيزر بالدجاج",560,"160 g tavuk, göbek salata, kruton ekmek, parmesan, Sezar sos (mayonez, hardal, kapari çiçeği, ançüez)","160 g chicken, iceberg lettuce, croutons, parmesan, Caesar dressing (mayonnaise, mustard, capers, anchovy)","160 غ دجاج، خس، خبز محمّص، بارميزان، صوص سيزر (مايونيز، خردل، كبر، أنشوجة)",["G","M","Y","B","H"],"salad"],
   ...
   { tr:"Makarnalar", en:"Pasta", ar:"معكرونة", i:[
    ["Spagetti Bolonez","Spaghetti Bolognese","سباغيتي بولونيز",665,"200 g spagetti, dana kıyma, domates sos (salça, domates, karabiber, tuz), fesleğenli pesto sos, parmesan","200 g spaghetti, minced beef, tomato sauce (tomato paste, tomato, black pepper, salt), basil pesto, parmesan","200 غ سباغيتي، لحم بقري مفروم، صلصة طماطم (معجون طماطم، طماطم، فلفل أسود، ملح)، بيستو الريحان، بارميزان",["G","M","N"],"pasta"],
    ["Mac & Cheese","Mac & Cheese","ماك آند تشيز",665,"200 g makarna, cheddar, kaşar, krema, tereyağı","200 g macaroni, cheddar, kashar cheese, cream, butter","200 غ معكرونة، شيدر، قشقوان، كريمة، زبدة",["G","M"],"pasta","mac"],
    ["Penne Arrabbiata","Penne Arrabbiata","بيني أرابياتا",635,"200 g penne, domates sos (salça, domates, karabiber, tuz), fesleğenli pesto sos, pul biber, siyah zeytin, zeytinyağı","200 g penne, tomato sauce (tomato paste, tomato, black pepper, salt), basil pesto, chilli flakes, black olives, olive oil","200 غ بيني، صلصة طماطم (معجون طماطم، طماطم، فلفل أسود، ملح)، بيستو الريحان، رقائق فلفل حار، زيتون أسود، زيت زيتون",["G","M","N"],"pasta"],
    ["Fettuccine Alfredo","Fettuccine Alfredo","فيتوتشيني ألفريدو",650,"200 g fettuccine, 80 g tavuk, krema, parmesan, tereyağı, mantar, tuz, karabiber","200 g fettuccine, 80 g chicken, cream, parmesan, butter, mushroom, salt, black pepper","200 غ فيتوتشيني، 80 غ دجاج، كريمة، بارميزان، زبدة، فطر، ملح، فلفل أسود",["G","M","Y"],"pasta"],
    ["Noodle Sebzeli","Vegetable Noodles","نودلز بالخضار",635,"200 g noodle, renkli biber, havuç, soya filizi, soya sos, susam yağı, susam","200 g noodles, bell peppers, carrot, bean sprouts, soy sauce, sesame oil, sesame","200 غ نودلز، فلفل ملوّن، جزر، براعم الصويا، صلصة صويا، زيت سمسم، سمسم",["G","S","SS","Y"],"pasta","noodle"],
    ["Noodle Tavuklu","Chicken Noodles","نودلز بالدجاج",650,"200 g noodle, 80 g tavuk, renkli biber, havuç, soya filizi, soya sos, susam yağı, susam","200 g noodles, 80 g chicken, bell peppers, carrot, bean sprouts, soy sauce, sesame oil, sesame","200 غ نودلز، 80 غ دجاج، فلفل ملوّن، جزر، براعم الصويا، صلصة صويا، زيت سمسم، سمسم",["G","S","SS","Y"],"pasta"]]}
  ]},
{ id:"burger", tr:"Burgerler & Wrapler", en:"Burgers & Wraps", ar:"برجر ولفائف",
  ...
  g:[
   { tr:"Burgerler", en:"Burgers", ar:"برجر", i:[
    ["Kule İstanbul Burger","Kule İstanbul Burger","برجر كوله إسطنبول",820,"180 g burger köftesi, kıvırcık, domates, turşu, mantar sos (mantar, krema, tuz, karabiber), patates","180 g beef patty, lettuce, tomato, pickles, mushroom sauce (mushroom, cream, salt, black pepper), fries","180 غ لحم برجر، خس، طماطم، مخلل، صوص فطر (فطر، كريمة، ملح، فلفل أسود)، بطاطس",["G","M","Y","SS"],"burger","kuleburger"],
    ...
    ["Tavuk Burger","Chicken Burger","برجر دجاج",745,"180 g özel soslu tavuk (yumurta, un, süt, soya sosu, tuz, karabiber, Cajun baharatı), kıvırcık, domates, turşu, cheddar peyniri, patates","180 g chicken in special sauce (egg, flour, milk, soy sauce, salt, black pepper, Cajun spice), lettuce, tomato, pickles, cheddar, fries","180 غ دجاج بصوص خاص (بيض، دقيق، حليب، صلصة صويا، ملح، فلفل أسود، توابل كاجون)، خس، طماطم، مخلل، جبنة شيدر، بطاطس",["G","M","Y","S","SS"],"burger","chickenburger"]]},
   { tr:"Wrapler", en:"Wraps", ar:"لفائف", i:[
    ...
    ["Tavuklu Wrap","Chicken Wrap","لفافة دجاج",730,"170 g jülyen tavuk, soğan, renkli biberler, Sweet Chili sos, patates","170 g julienne chicken, onion, bell peppers, sweet chilli sauce, fries","170 غ دجاج شرائح، بصل، فلفل ملوّن، صوص سويت تشيلي، بطاطس",["G"],"wrap"],
    ["Kaşarlı Köfteli Wrap","Meatball & Kashar Wrap","لفافة كفتة بالقشقوان",765,"170 g köfte, soğan, renkli biberler, kaşar peyniri, soya sosu, patates","170 g meatballs, onion, bell peppers, kashar cheese, soy sauce, fries","170 غ كفتة، بصل، فلفل ملوّن، قشقوان، صلصة صويا، بطاطس",["G","M","S"],"wrap"]]}
  ]},
{ id:"ana", tr:"Ana Yemekler", en:"Main Courses", ar:"الأطباق الرئيسية",
  ...
  g:[
   ...
   { tr:"Tavuklar", en:"Chicken", ar:"دجاج", i:[
    ["Kaymaklı Kule Tavuk","Kule Chicken with Cream Sauce","دجاج كوله بصوص القشطة",840,"180 g tavuk, süzme yoğurt, çıtır yufka, közlenmiş biber & domates, özel kaymak sos (kaymak, tereyağı, barbekü sos), patates","180 g chicken, strained yoghurt, crispy yufka, roasted pepper & tomato, special cream sauce (clotted cream, butter, BBQ sauce), fries","180 غ دجاج، لبن مصفّى، يوفكا مقرمشة، فلفل وطماطم مشوية، صوص قشطة خاص (قشطة، زبدة، صوص باربكيو)، بطاطس",["G","M"],"chicken","kaymaklitavuk"],
    ...
    ["Tavuk Sote","Chicken Sauté","دجاج سوتيه",790,"180 g tavuk, renkli biberler, soğan, domates, sarımsak, pilav ve patates","180 g chicken, bell peppers, onion, tomato, garlic, rice and fries","180 غ دجاج، فلفل ملوّن، بصل، طماطم، ثوم، أرز وبطاطس",[],"chicken"],
    ...
    ["Tavuk Külbastı","Grilled Chicken Külbastı","كولباستي دجاج",820,"180 g marine edilmiş tavuk göğsü, patlıcan beğendi, közlenmiş biber & domates, patates","180 g marinated chicken breast, smoked aubergine purée, roasted pepper & tomato, fries","180 غ صدر دجاج متبّل، بيغندي باذنجان، فلفل وطماطم مشوية، بطاطس",["M"],"chicken"]]},
   { tr:"Schnitzel", en:"Schnitzel", ar:"شنيتزل", i:[
    ["Chicken Schnitzel","Chicken Schnitzel","شنيتزل دجاج",775,"200 g panelenmiş tavuk, schnitzel sosu (galeta unu, pane, yumurta, un, soya sosu, tuz, Cajun baharatı), mini salata, patates","200 g breaded chicken, schnitzel coating (breadcrumbs, breading, egg, flour, soy sauce, salt, Cajun spice), side salad, fries","200 غ دجاج مقرمش بالبقسماط، خلطة الشنيتزل (بقسماط، خلطة تغليف، بيض، دقيق، صلصة صويا، ملح، توابل كاجون)، سلطة صغيرة، بطاطس",["G","Y","S"],"chicken"],
    ["Mantar Soslu Schnitzel","Schnitzel with Mushroom Sauce","شنيتزل بصوص الفطر",795,"180 g panelenmiş tavuk, schnitzel sosu (galeta unu, pane, yumurta, un, soya sosu, tuz, Cajun baharatı), mantar sos, mini salata, patates","180 g breaded chicken, schnitzel coating (breadcrumbs, breading, egg, flour, soy sauce, salt, Cajun spice), mushroom sauce, side salad, fries","180 غ دجاج مقرمش، خلطة الشنيتزل (بقسماط، خلطة تغليف، بيض، دقيق، صلصة صويا، ملح، توابل كاجون)، صوص فطر، سلطة صغيرة، بطاطس",["G","Y","M","S"],"chicken"],
    ["Cheddar Soslu Schnitzel","Schnitzel with Cheddar Sauce","شنيتزل بصوص الشيدر",795,"180 g panelenmiş tavuk, schnitzel sosu (galeta unu, pane, yumurta, un, soya sosu, tuz, Cajun baharatı), cheddar sos, krema, mini salata, patates","180 g breaded chicken, schnitzel coating (breadcrumbs, breading, egg, flour, soy sauce, salt, Cajun spice), cheddar sauce, cream, side salad, fries","180 غ دجاج مقرمش، خلطة الشنيتزل (بقسماط، خلطة تغليف، بيض، دقيق، صلصة صويا، ملح، توابل كاجون)، صوص شيدر، كريمة، سلطة صغيرة، بطاطس",["G","Y","M","S"],"chicken"]]},
...
{ id:"et", tr:"Kırmızı Etler", en:"Red Meat", ar:"اللحوم الحمراء",
  ...
  g:[
   { tr:"Izgaralar", en:"Grills", ar:"مشاوي", note:"Közlenmiş biber & domates, pilav ve patates eşliğinde", noteEn:"Served with roasted pepper & tomato, rice and fries", noteAr:"تُقدَّم مع فلفل وطماطم مشوية، أرز وبطاطس", i:[
    ["Karışık Izgara","Mixed Grill","مشاوي مشكّلة",2500,"1 kuzu pirzola, 200 g antrikot, 2 köfte, 2 tavuk kanat, 1 tavuk bonfile (zeytinyağı ve kekikle marine edilmiş), "+SIDE_TR,"1 lamb chop, 200 g ribeye, 2 meatballs, 2 chicken wings, 1 chicken fillet (marinated in olive oil and thyme), "+SIDE_EN,"ريشة غنم، 200 غ أنتريكوت، كفتتان، جناحا دجاج، فيليه دجاج (متبّل بزيت الزيتون والزعتر)، "+SIDE_AR,["G"],"steak","karisik"],
    ["Kuzu Pirzola (3 Parça)","Lamb Chops (3 pcs)","ريش غنم (3 قطع)",1320,"3 parça kuzu pirzola (zeytinyağı ve kekikle marine edilmiş), "+SIDE_TR,"3 lamb chops (marinated in olive oil and thyme), "+SIDE_EN,"3 ريش غنم (متبّل بزيت الزيتون والزعتر)، "+SIDE_AR,[],"steak","pirzola"],
    ["Kuzu Pirzola (4 Parça)","Lamb Chops (4 pcs)","ريش غنم (4 قطع)",1570,"4 parça kuzu pirzola (zeytinyağı ve kekikle marine edilmiş), "+SIDE_TR,"4 lamb chops (marinated in olive oil and thyme), "+SIDE_EN,"4 ريش غنم (متبّل بزيت الزيتون والزعتر)، "+SIDE_AR,[],"steak","pirzola"],
    ["Antrikot","Ribeye Steak","أنتريكوت",1320,"200 g antrikot (zeytinyağı ve kekikle marine edilmiş), "+SIDE_TR,"200 g ribeye (marinated in olive oil and thyme), "+SIDE_EN,"200 غ أنتريكوت (متبّل بزيت الزيتون والزعتر)، "+SIDE_AR,[],"steak","antrikot"],
    ["Bonfile","Tenderloin Steak","بونفيليه (فيليه بقري)",1450,"200 g bonfile (zeytinyağı ve kekikle marine edilmiş), "+SIDE_TR,"200 g tenderloin (marinated in olive oil and thyme), "+SIDE_EN,"200 غ فيليه (متبّل بزيت الزيتون والزعتر)، "+SIDE_AR,[],"steak","bonfile"],
    ["Mantar Soslu Bonfile","Tenderloin with Mushroom Sauce","فيليه بصوص الفطر",1500,"200 g bonfile (zeytinyağı ve kekikle marine edilmiş), mantar sos, "+SIDE_TR,"200 g tenderloin (marinated in olive oil and thyme), mushroom sauce, "+SIDE_EN,"200 غ فيليه (متبّل بزيت الزيتون والزعتر)، صوص فطر، "+SIDE_AR,["M"],"steak","mantarbonfile"],
   ...
   { tr:"Fajitalar", en:"Fajitas", ar:"فاهيتا", note:"Kekik ve zeytinyağı ile marine edilir; renkli biberler, soğan, Sweet Chili sos, süzme yoğurt, özel Kule sos ve lavaş eşliğinde", noteEn:"Marinated in thyme and olive oil; served with bell peppers, onion, sweet chilli sauce, strained yoghurt, special Kule sauce and lavash", noteAr:"متبّلة بالزعتر وزيت الزيتون؛ تُقدَّم مع فلفل ملوّن، بصل، صوص سويت تشيلي، لبن مصفّى، صوص كوله الخاص وخبز لافاش", i:[
    ["Fajita","Beef Fajita","فاهيتا لحم",1470,"200 g kekik ve zeytinyağı ile marine edilmiş et, renkli biberler, soğan, Sweet Chili sos, süzme yoğurt, özel Kule sos (Sweet Chili sos, mayonez, acı sos, salsa sos), lavaş","200 g beef marinated in thyme and olive oil, bell peppers, onion, sweet chilli sauce, strained yoghurt, special Kule sauce (sweet chilli sauce, mayonnaise, hot sauce, salsa), lavash","200 غ لحم متبّل بالزعتر وزيت الزيتون، فلفل ملوّن، بصل، صوص سويت تشيلي، لبن مصفّى، صوص كوله الخاص (صوص سويت تشيلي، مايونيز، صوص حار، صلصة سالسا)، لافاش",["G","M","Y"],"fajita","fajita"],
    ["Combo Fajita","Combo Fajita","فاهيتا كومبو",1520,"150 g et ve 150 g tavuk (kekik ve zeytinyağı ile marine edilmiş), renkli biberler, soğan, Sweet Chili sos, süzme yoğurt, özel Kule sos (Sweet Chili sos, mayonez, acı sos, salsa sos), lavaş","150 g beef and 150 g chicken (marinated in thyme and olive oil), bell peppers, onion, sweet chilli sauce, strained yoghurt, special Kule sauce (sweet chilli sauce, mayonnaise, hot sauce, salsa), lavash","150 غ لحم و150 غ دجاج (متبّل بالزعتر وزيت الزيتون)، فلفل ملوّن، بصل، صوص سويت تشيلي، لبن مصفّى، صوص كوله الخاص (صوص سويت تشيلي، مايونيز، صوص حار، صلصة سالسا)، لافاش",["G","M","Y"],"fajita","combofajita"]]}
  ]},
