...
{ id:"burger", tr:"Burgerler & Wrapler", en:"Burgers & Wraps", ar:"برجر ولفائف",
  ...
  g:[
   { tr:"Burgerler", en:"Burgers", ar:"برجر", i:[
    ["Kule İstanbul Burger","Kule İstanbul Burger","برجر كوله إسطنبول",820,"180 g burger köftesi, kıvırcık, domates, turşu, mantar sos (mantar, krema, tuz, karabiber), hamburger sosu (mayonez, Sweet Chili sos, az acı, tuz, pul biber), patates ve Sweet Chili sos eşliğinde","180 g beef patty, lettuce, tomato, pickles, mushroom sauce (mushroom, cream, salt, black pepper), burger sauce (mayonnaise, sweet chilli sauce, mild chilli, salt, chilli flakes), served with fries and sweet chilli sauce","180 غ لحم برجر، خس، طماطم، مخلل، صوص فطر (فطر، كريمة، ملح، فلفل أسود)، صوص البرجر (مايونيز، صوص سويت تشيلي، فلفل خفيف، ملح، رقائق فلفل)، تُقدَّم مع البطاطس وصوص سويت تشيلي",["G","M","Y","SS"],"burger","kuleburger"],
    ["Cheese Burger","Cheeseburger","تشيز برجر",815,"180 g burger köftesi, kıvırcık, domates, turşu, cheddar peyniri, hamburger sosu (mayonez, Sweet Chili sos, az acı, tuz, pul biber), patates ve Sweet Chili sos eşliğinde","180 g beef patty, lettuce, tomato, pickles, cheddar, burger sauce (mayonnaise, sweet chilli sauce, mild chilli, salt, chilli flakes), served with fries and sweet chilli sauce","180 غ لحم برجر، خس، طماطم، مخلل، جبنة شيدر، صوص البرجر (مايونيز، صوص سويت تشيلي، فلفل خفيف، ملح، رقائق فلفل)، تُقدَّم مع البطاطس وصوص سويت تشيلي",["G","M","Y","SS"],"burger"],
    ["Jumbo Cheese Burger","Jumbo Cheeseburger","جامبو تشيز برجر",925,"360 g burger köftesi, kıvırcık, domates, turşu, cheddar peyniri, hamburger sosu (mayonez, Sweet Chili sos, az acı, tuz, pul biber), patates ve Sweet Chili sos eşliğinde","360 g beef patty, lettuce, tomato, pickles, cheddar, burger sauce (mayonnaise, sweet chilli sauce, mild chilli, salt, chilli flakes), served with fries and sweet chilli sauce","360 غ لحم برجر، خس، طماطم، مخلل، جبنة شيدر، صوص البرجر (مايونيز، صوص سويت تشيلي، فلفل خفيف، ملح، رقائق فلفل)، تُقدَّم مع البطاطس وصوص سويت تشيلي",["G","M","Y","SS"],"burger","jumbo"],
    ["Tavuk Burger","Chicken Burger","برجر دجاج",745,"180 g özel soslu tavuk (yumurta, un, süt, panko, galeta unu, pane, soya sosu, tuz, karabiber, Cajun baharatı), kıvırcık, domates, turşu, cheddar peyniri, hamburger sosu (mayonez, Sweet Chili sos, az acı, tuz, pul biber), patates ve Sweet Chili sos eşliğinde","180 g chicken in special coating (egg, flour, milk, panko, breadcrumbs, breading, soy sauce, salt, black pepper, Cajun spice), lettuce, tomato, pickles, cheddar, burger sauce (mayonnaise, sweet chilli sauce, mild chilli, salt, chilli flakes), served with fries and sweet chilli sauce","180 غ دجاج بخلطة خاصة (بيض، دقيق، حليب، بانكو، بقسماط، خلطة تغليف، صلصة صويا، ملح، فلفل أسود، توابل كاجون)، خس، طماطم، مخلل، جبنة شيدر، صوص البرجر (مايونيز، صوص سويت تشيلي، فلفل خفيف، ملح، رقائق فلفل)، تُقدَّم مع البطاطس وصوص سويت تشيلي",["G","M","Y","S","SS"],"burger","chickenburger"]]},
   { tr:"Wrapler", en:"Wraps", ar:"لفائف", i:[
    ["Etli Wrap","Beef Wrap","لفافة لحم",810,"170 g jülyen et, soğan, renkli biberler, kaşar peyniri, özel sos (soya sosu, Cajun baharatı), patates ve Sweet Chili sos eşliğinde","170 g julienne beef, onion, bell peppers, kashar cheese, special sauce (soy sauce, Cajun spice), served with fries and sweet chilli sauce","170 غ لحم شرائح، بصل، فلفل ملوّن، قشقوان، صوص خاص (صلصة صويا، توابل كاجون)، تُقدَّم مع البطاطس وصوص سويت تشيلي",["G","M","Y","S"],"wrap","wrap"],
    ["Tavuklu Wrap","Chicken Wrap","لفافة دجاج",730,"170 g jülyen tavuk, soğan, renkli biberler, kaşar peyniri, özel sos (soya sosu, Cajun baharatı), patates ve Sweet Chili sos eşliğinde","170 g julienne chicken, onion, bell peppers, kashar cheese, special sauce (soy sauce, Cajun spice), served with fries and sweet chilli sauce","170 غ دجاج شرائح، بصل، فلفل ملوّن، قشقوان، صوص خاص (صلصة صويا، توابل كاجون)، تُقدَّم مع البطاطس وصوص سويت تشيلي",["G","M","S"],"wrap"],
    ["Kaşarlı Köfteli Wrap","Meatball & Kashar Wrap","لفافة كفتة بالقشقوان",765,"170 g köfte, soğan, renkli biberler, kaşar peyniri, özel sos (soya sosu, Cajun baharatı), patates ve Sweet Chili sos eşliğinde","170 g meatballs, onion, bell peppers, kashar cheese, special sauce (soy sauce, Cajun spice), served with fries and sweet chilli sauce","170 غ كفتة، بصل، فلفل ملوّن، قشقوان، صوص خاص (صلصة صويا، توابل كاجون)، تُقدَّم مع البطاطس وصوص سويت تشيلي",["G","M","S"],"wrap"]]}
  ]},
